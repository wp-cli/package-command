...
', $manipulator->getContents());
    ...
    {
        $manipulator = new JsonManipulator($json);
        $this->assertTrue($manipulator->addLink($type, $package, $constraint, $sortPackages, true /*caseInsensitive*/));
        $this->assertEquals($expected, $manipulator->getContents());
    }
...
',
    ...
    public function testAddSubNodeCase($json, $mainNode, $name, $caseInsensitive, $expected)
    {
        ...
        $this->assertTrue($manipulator->addSubNode($mainNode, $name, "val" /*value*/, $caseInsensitive));
...
',
    ...
    public function testRemoveSubNodeCaseInsensitive($json, $mainNode, $name, $expected, $expectedContent = null)
    {
        ...
        $this->assertEquals($expected, $manipulator->removeSubNode($mainNode, $name, true));
        if (null !== $expectedContent) {
            $this->assertEquals($expectedContent, $manipulator->getContents());
        }
    }
